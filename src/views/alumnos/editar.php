...
<h2 class="mb-4"><i class="bi bi-pencil-square"></i> Editar Alumno</h2>
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="alumnos.php?action=editar&id=<?php echo $alumno['id']; ?>">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="nombre" class="form-label">Nombre <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="nombre" name="nombre" maxlength="50"
                        value="<?php echo isset($_POST['nombre']) ? htmlspecialchars($_POST['nombre']) : htmlspecialchars($alumno['nombre']); ?>"
                        required>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="apellido" name="apellido" maxlength="50"
                        value="<?php echo isset($_POST['apellido']) ? htmlspecialchars($_POST['apellido']) : htmlspecialchars($alumno['apellido']); ?>"
                        required>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="correo" name="correo" maxlength="100"
                    value="<?php echo isset($_POST['correo']) ? htmlspecialchars($_POST['correo']) : htmlspecialchars($alumno['correo']); ?>"
                    required>
